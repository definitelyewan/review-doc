...
export const actions = {
  ...
  igdb_search: async ({request}) => {
    ...
    const igdb_init = await igdb.query('games',`fields *; search "${media_search_word}"; where (version_parent = null & (category = 0 | category = 10 | category = 8 | category = 4));limit 10;`);
